...
from doc.models import Document, DocumentParagraphs, ParagraphVector, ParagraphVectorType, DocumentVector
import pandas as pd
import math
...
def apply(folder_name, Country):
    DocumentVector.objects.filter(paragraph__document_id__country_id__id = Country.id).delete()
