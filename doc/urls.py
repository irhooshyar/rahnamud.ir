...
urlpatterns = [
    ...
    path('fill_semantic_similarity/', views.fill_semantic_similarity, name='fill_semantic_similarity'),
    ...
    path(
        'Search_Rahbari_Column_ES/<int:country_id>/<str:type_name>/<str:label_name_list>/<str:from_year>/<str:to_year>/<str:rahbari_type>/<str:place>/<str:text>/<str:search_type>/<int:curr_page>/<int:page_size>/',
