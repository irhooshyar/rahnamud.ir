...
urlpatterns = [
    ...
    path('SearchRahbari_ES/<int:country_id>/<int:type_id>/<str:label_name>/<int:from_year>/<int:to_year>/<str:rahbari_type>/<str:document_ids>/<str:place>/<str:text>/<str:search_type>/<int:curr_page>/',views.SearchRahbari_ES, name='SearchRahbari_ES'),
    ...
    path('Search_Rahbari_Column_ES/<int:country_id>/<str:type_name>/<str:label_name_list>/<str:from_year>/<str:to_year>/<str:rahbari_type>/<str:place>/<str:text>/<str:search_type>/<int:curr_page>/<int:page_size>/',views.Search_Rahbari_Column_ES, name='Search_Rahbari_Column_ES'),
